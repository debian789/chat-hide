  ...
  componentWillMount() {
    if (this.props.mensaje) {
      ...
      if ((this.props.mensaje.split('.').indexOf('jpg') !== -1) || (this.props.mensaje.split('.').indexOf('gif') !== -1) || (this.props.mensaje.split('.').indexOf('png') !== -1) || (this.props.mensaje.split('.').indexOf('jpeg') !== -1)) {
        element = <div className="containerSubItems"><img alt="img" src={URL_SERVER_SOCKET + '/'+this.props.mensaje}/></div>
        ...
        element = <Video
          ...
          <source src={URL_SERVER_SOCKET + '/'+this.props.mensaje} type="video/mp4"/>
        </Video>
